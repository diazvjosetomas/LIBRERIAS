...
<div class="container" style="padding-top:0px;">		
		<div class="panel panel-default" style="box-shadow:2px 2px 5px;margin:0 auto;width:100%;">
			<div class="panel-heading" style="text-align: center;font-size: 25px;padding: 20px;">Registro de Habitaci&oacute;n</div>
			<div class="panel-body">
			<?=input_hidden("idhabitacion","")?>
			<?=input_text("<b>Nombre:</b>","nombre","","","","mayusculas(this)","")?>
...
<div class="container" style="margin-top:50px;">
	<div class="panel panel-default" style="box-shadow:2px 2px 5px;margin:0 auto;width:100%;">
		<div class="panel-heading" style="text-align: center;font-size: 25px;padding: 20px;">Habitaciones Registradas</div>
		<div class="panel-body">
...
function pag(num)
{
	...
	$("#divDatos").load("habitaciones/habitacion_data.php",{accion:accion,pg:pg},function()
		{
...
function guardar(){
	if($("#nombre").val()==""){
		crear_modal("Información","Debe llenar el campo nombre","info","nombre","","");
		return false;
	}
	if($("#accion").val()==""){
		$("#accion").val("guardar");
	}
	$.get("habitaciones/habitacion_data.php",$("#form1").serialize(),function(response){
		json = eval('('+response+')');
...
function eliminar(id){
	$.get("habitaciones/habitacion_data.php",{accion:"eliminar",idhabitacion:id},function(response){
		json = eval('('+response+')');
...
function consultar(){
	...
	$.get("habitaciones/habitacion_data.php",{accion:"consultar",filnombre:filnombre,filestatus:filestatus},function(response){
		$("#divDatos").html(response);
	});
}

function modHabitacion(idhabitacion,nombre,estatus){
