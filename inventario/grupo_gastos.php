...
<div class="container" style="padding-top:0px;">		
		<div class="panel panel-default" style="box-shadow:2px 2px 5px;margin:0 auto;width:100%;">
			<div class="panel-heading" style="text-align: center;font-size: 25px;padding: 20px;">Registro de Grupo de Gastos</div>
			<div class="panel-body">
			<?=input_hidden("idgrupo","")?>
...
<div class="container" style="margin-top:50px;">
	<div class="panel panel-default" style="box-shadow:2px 2px 5px;margin:0 auto;width:100%;">
		<div class="panel-heading" style="text-align: center;font-size: 25px;padding: 20px;">Grupo Gastos Registrados</div>
		<div class="panel-body">
...
function pag(num)
{
	...
	$("#divDatos").load("inventario/grupo_data.php",{accion:accion,pg:pg},function()
		{
...
function guardar(){
	...
	$.get("inventario/grupo_data.php",$("#form1").serialize(),function(response){
		json = eval('('+response+')');
...
function eliminar(id){
	$.get("inventario/grupo_data.php",{accion:"eliminar",idgrupo:id},function(response){
		json = eval('('+response+')');
...
function consultar(){
	...
	$.get("inventario/grupo_data.php",{accion:"consultar",filnombre:filnombre,filestatus:filestatus},function(response){
		$("#divDatos").html(response);
	});
}

function modGrupo(idgrupo,nombre,estatus){
	$("#idgrupo").val(idgrupo);
	$("#nombre").val(nombre);
	$("#estatus").val(estatus);
	if(estatus==1){
