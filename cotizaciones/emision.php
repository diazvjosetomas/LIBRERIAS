...
<div class="container" style="padding-top:0px;">		
		<div id="panel-contenido" class="panel panel-default" style="box-shadow:2px 2px 5px;margin:0 auto;width:100%;display:none;">
			<div class="panel-heading" style="text-align: center;font-size: 25px;padding: 20px;">Emisi&oacute;n de cotizaci&oacute;n</div>
			<div class="panel-body">

			<div class="form-group">
				<label class='col-xs-2 control-label'><i class="fa fa-check-circle"></i><em>Datos de la cotizaci&oacute;n</em></label>
				<div>
			...
			<?
				...
				input_fecha("<b>Fecha:</b>","fecha_ingreso","$ancho","$fecha","$onclick","$onblur","disabled");
				input_textarea("<b>Observaciones:</b>","obs","5","$onclick","$onblur","$attr","80px");
				select("<b>Motivo:</b>","asunto","$ancho","$onchange","cotizaciones","$where","id_cotizacion","asunto","$onclick","$onblur","$attr","$options","$selected","$class");
			?>
				<div class="form-group" style="text-align:center;margin-top:15px;">
				    <button type="button" class="btn btn-success" onclick="ingresarPaciente()">Emitir cotizaci&oacute;n</button>
...
function buscar_paciente()
{
	...
	$.post("cotizaciones/emision_datos.php",
	{
...
function emitirCotizacion()
{
	...
	var obs 		  =$("#obs").val();
	var id_cotizacion =$("#asunto").val();

	capaBloqueo();
	$.post("cotizaciones/emision_datos.php",
	{
		"accion":"emitirCotizacion",
		"cedula":cedula,
